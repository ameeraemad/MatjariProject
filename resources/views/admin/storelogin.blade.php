...
<header>
       ...
       <div class="text-center">
        <div class="container loging text-center">
            ...
            <a href="{{route('newstore',$user)}}" class="btn btn-warning">create a new store</a>
        </div>
        </div>
        <h3>Stores</h3>
        <div class="main_login row  container">
            ...
            <div class="signupForm mt-5 col-12">
               ...
               <div class="my-4">
                      <a href="{{ route('mystore.index',$user_store->slug)}}" >
                       <div class="card  ">
                        <div class="row">
                      <div class="col-4">
                             @if ($user_store->logo)
                                    <img src="{{ asset('img/' . $user_store->logo) }}" 
                       ...
                       <h2>{{$user_store->name}}</h2>
                       <h5 class="pt-2">{{$user_store->slug}}</h5>
                   </div>
                   </div>
                </div></a>
               </div>
