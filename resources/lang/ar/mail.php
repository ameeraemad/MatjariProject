...
return [
    'verification_code' => 'تفعيل حساب :name في  Matjari',
    'verification_code_line_1' => 'شكرا لكٍ للتسجيل في  Matjari لتفعيل اشتراكك قم بنسخ الرمز ادناه واستخدميه في التطبيق',
